...
public class NotificationUtils {
    ...
    private static final int DRINK_REMINDER_PENDING_INTENT_ID = 3418;
    private static final int IGNORE_REMINDER_PENDING_INTENT_ID = 3419;
    /**
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context,
                DRINK_REMINDER_PENDING_INTENT_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
