...
public class NotificationUtils {
    ...
    private static final int PENDING_INTENT_REQUEST_CODE = 234434;

    private static final int NOTIFICATION_INTENT_REQUEST_CODE = 1234432;

    private static final String NOTIFICATION_CHANNEL_ID = "water.notificationChannel";
    ...
    // https://developer.android.com/training/notify-user/build-notification.html
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat
                ...
                .setStyle(new NotificationCompat
                        .BigTextStyle()
                        .bigText(resources.getString(R.string.charging_reminder_notification_body)))
        ...
        notificationManager.notify(NOTIFICATION_INTENT_REQUEST_CODE, notificationBuilder.build());
    }
    ...
    // TODDONEO (4) Create a helper method called largeIcon which takes in a Context as a parameter and
