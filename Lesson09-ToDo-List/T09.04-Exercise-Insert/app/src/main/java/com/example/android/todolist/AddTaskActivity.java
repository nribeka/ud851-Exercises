...
public class AddTaskActivity extends AppCompatActivity {
    ...
    public void onClickAddTask(View view) {
        ...
        TextView textViewDescription = findViewById(R.id.editTextTaskDescription);
        ...
        Uri returnedUri = getContentResolver().insert(TaskContract.TaskEntry.CONTENT_URI , contentValues);

        // DONE (8) Display the URI that's returned with a Toast
        if (returnedUri != null) {
            Toast toast = Toast.makeText(this, returnedUri.toString(), Toast.LENGTH_LONG);
            toast.show();
        }
