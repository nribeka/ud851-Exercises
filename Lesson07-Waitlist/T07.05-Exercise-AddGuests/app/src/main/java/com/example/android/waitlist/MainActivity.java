...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText mNewGuesNameEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNewGuesNameEditText = findViewById(R.id.person_name_edit_text);
    ...
    public void addToWaitlist(View view) {
        ...
        if ("".equals(mNewPartySizeEditText.getText().toString())
                || "".equals(mNewPartySizeEditText.getText().toString())) {
            return;
        }
